...
- (BOOL)_isOutgoingVideoFileNameTestPassedWithFriend:(TBMFriend*)friend video:(TBMVideo*)video
{
    ...
    NSString* zOutgoingFileName = [ZZRemoteStorageValueGenerator outgoingVideoRemoteFilenameWithFriendMkey:video.friend.mkey friendCKey:video.friend.ckey videoID:video.videoId];
    NSString* tbmOutgointFileName = [TBMRemoteStorageHandler outgoingVideoRemoteFilename:video.friend videoID:video.videoId];
    
    isEqual = [zOutgoingFileName isEqualToString:tbmOutgointFileName];
