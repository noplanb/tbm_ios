...
// ANDrawer
#define COCOAPODS_POD_AVAILABLE_ANDrawer
#define COCOAPODS_VERSION_MAJOR_ANDrawer 1
#define COCOAPODS_VERSION_MINOR_ANDrawer 0
#define COCOAPODS_VERSION_PATCH_ANDrawer 1
