...
#import "TBMCarouselFeaturePresenter.h"
#import "TBMCarouselFeatureView.h"


@implementation TBMCarouselFeaturePresenter {
    BOOL _isPresented;
}

- (instancetype)init {
    self = [super init];
    [self setFeatureView:[TBMCarouselFeatureView new]];
