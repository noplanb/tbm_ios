...
#import "TBMDeprecatedRegisterViewController.h"
#import "TBMConfig.h"
#import "TBMUser.h"
#import "TBMFriend.h"
...
@interface TBMDeprecatedRegisterViewController ()
...
@implementation TBMDeprecatedRegisterViewController
...
- (void) addFriends:(NSMutableArray *)friends{
    ...
    for (NSDictionary *f in friends){
        TBMFriend *friend = [TBMFriend createWithId:[f objectForKey:@"id"]];
