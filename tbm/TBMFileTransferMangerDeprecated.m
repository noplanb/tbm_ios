...
#import "TBMFileTransferMangerDeprecated.h"
...
@implementation TBMFileTransferMangerDeprecated
...
- (void) createAndStartUploadTaskWithFriendId:(NSString *)friendId{
    ...
    [body appendData:[NSData dataWithContentsOfURL:[TBMVideoRecorder outgoingVideoUrlWithMarker:friendId]]];
